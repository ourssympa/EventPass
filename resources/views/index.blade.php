				...
				<div class="container">
					...
					<a class="navbar-brand order-1 order-lg-0 ml-lg-0 ml-2 me-auto" href="index.html">
						<div class="res-main-logo">
							<img src="{{Asset('asset/images/logo-icon.svg')}}" alt="">
						</div>
						<div class="main-logo" id="logo">
							<img src="{{Asset('asset/images/logo.svg')}}" alt="">
							<img class="logo-inverse" src="{{Asset('asset/images/dark-logo.svg')}}" alt="">
						</div>
					</a>
				...
				<div class="row justify-content-center">
					<div class="col-xl-7 col-lg-9 col-md-10">
						<div class="hero-banner-content">
							<h2>Le système de réservation et de vente de billets en ligne le plus facile et le plus puissant.</h2>
							<p>Event Pass est une plateforme complète de billetterie pour les organisateurs, promoteurs et gestionnaires d'événements. Créez, promouvez et gérez facilement des événements de tout type et de toute taille.</p>
							<a href="create.html" class="main-btn btn-hover">Créer un événement <i class="fa-solid fa-arrow-right ms-3"></i></a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="event-filter-items">
							<div class="featured-controls">
								...
								<div class="browse-btn">
									<a href="{{ route('all_event') }}" class="main-btn btn-hover ">Voir Tout les événements</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="testimonial-block p-80">
			<div class="container">
				<div class="row">
					<div class="col-lg-10">
						<div class="main-title">
							<h3>Transformant des milliers d'organisateurs d'événements comme vou</h3>
							<p>Faites partie d'une équipe gagnante. Nous nous efforçons constamment d'offrir le meilleur à nos clients, que ce soit une nouvelle fonctionnalité produit, une assistance pour la mise en place de vos événements ou même le support de vos clients afin qu'ils puissent facilement acheter des billets et participer à vos événements. Voici ce que disent certains de nos clients,</p>
						</div>
					</div>
					<div class="col-lg-12">
					...
					<div class="col-lg-12">
						<div class="organisations-area">
							<div class="owl-carousel organisations-slider owl-theme">
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-1.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-2.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-3.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-4.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-5.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-6.png')}}" alt=""></a>
									</div>
								</div>
								<div class="item">
									<div class="sponsor">
										<a href="#"><img src="{{ Asset('asset/images/icons/sponsor-7.png')}}" alt=""></a>
									</div>
								</div>
							</div>
						</div>
